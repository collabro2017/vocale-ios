...
+ (void)showSuccessWithStatus:(NSString*)status
{
    ...
    [KGStatusBar performSelector:@selector(dismiss) withObject:self afterDelay:5.0 ];
}

+ (void)showWithStatus:(NSString*)status {
    //red: 33/255, green: 30/255, blue: 35/255, alpha: 1
    [[KGStatusBar sharedView] showWithStatus:status barColor:[UIColor colorWithRed:0.12941176f green:0.11764706f blue:0.13725490f alpha:1.0] textColor:[UIColor whiteColor]];
}
...
- (UILabel *)stringLabel {
    if (stringLabel == nil) {
		...
		stringLabel.font = [UIFont fontWithName:@"Raleway-Regular" size:14];
