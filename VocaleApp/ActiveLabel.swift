...
public class ActiveLabel: UILabel {
    ...
    private func setupLabel() {
        ...
        let touchRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(ActiveLabel.onTouch(_:)))
    ...
    private func addLinkAttribute(mutAttrString: NSMutableAttributedString) {
        ...
        for (type, elements) in activeElements {
            ...
            case .Hashtag: attributes[NSFontAttributeName] = UIFont.boldSystemFontOfSize(16.0)
    ...
    private func updateAttributesWhenSelected(isSelected: Bool) {
        ...
        if isSelected {
            ...
            case .Hashtag(_): attributes[NSFontAttributeName] = UIFont.boldSystemFontOfSize(16.0)
                attributes[NSForegroundColorAttributeName] = UIColor.whiteColor()
            ...
            case .Hashtag(_): attributes[NSFontAttributeName] = UIFont.boldSystemFontOfSize(16.0) ?? UIFont.boldSystemFontOfSize(16.0)
