...
class RRTagCollectionViewCell: UICollectionViewCell {
    ...
    func initContent(tag: Tag) {
        ...
        amSelected = tag.isSelected
        textContent.backgroundColor = UIColor.clearColor()
        self.textContent.layer.backgroundColor = (self.amSelected == true) ? colorSelectedTag.CGColor : colorUnselectedTag.CGColor
        self.textContent.textColor = (self.amSelected == true) ? colorTextSelectedTag : colorTextUnSelectedTag
    }
