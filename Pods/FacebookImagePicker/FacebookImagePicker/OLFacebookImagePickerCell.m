...
+ (void)initialize {
    ...
    {
        checkedIcon = [UIImage imageNamed:@"CTAssetsPickerChecked" inBundle:[NSBundle bundleForClass:[OLFacebookImagePickerCell class]] compatibleWithTraitCollection:nil];
    }
    else
    {
