...
- (void)viewDidLoad {
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"Back Arrow"] style:UIBarButtonItemStylePlain target:self action:@selector(onButtonDoneClicked)];
   // self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Logout" style:UIBarButtonItemStylePlain target:self action:@selector(onButtonLogoutClicked)];
    ...
    self.view.backgroundColor = [UIColor colorWithRed:0.12941176f green:0.13725490f blue:0.11764706f alpha:1.0f];
    self.view.backgroundColor = [UIColor colorWithRed:0.12941176f green:0.13725490f blue:0.11764706f alpha:1.0f];
    self.tableView.backgroundColor = [UIColor colorWithRed:0.12941176f green:0.13725490f blue:0.11764706f alpha:1.0f];
    [self.navigationController.navigationBar setBarTintColor:[UIColor colorWithRed:0.12941176f green:0.13725490f blue:0.11764706f alpha:1.0f]];
}
