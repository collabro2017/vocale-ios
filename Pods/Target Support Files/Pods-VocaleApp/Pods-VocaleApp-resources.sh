...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "FacebookImagePicker/FacebookImagePicker/FacebookImagePicker.xcassets"
  install_resource "FacebookImagePicker/FacebookImagePicker/OLAlbumViewController.xib"
  install_resource "FacebookImagePicker/FacebookImagePicker/OLPhotoViewController.xib"
