...
- (instancetype)initWithCollectionViewLayout:(UICollectionViewLayout *)layout
{
    ...
    if (self) {
        self.title = NSLocalizedString(@"Post Picture", nil);
...
- (void)loadView
{
    ...
    self.view.backgroundColor = [UIColor colorWithRed:0.13725490f green:0.12941176f blue:0.11764706f alpha:1.0f];
    ...
    self.collectionView.backgroundView.backgroundColor = [UIColor colorWithRed:0.13725490f green:0.12941176f blue:0.11764706f alpha:1.0f];
...
- (UISearchDisplayController *)searchController
{
    if (!_searchController)
    {
        ...
        _searchController.searchResultsTableView.backgroundColor = [UIColor colorWithRed:0.13725490f green:0.12941176f blue:0.11764706f alpha:1.0f];
        ...
        _searchController.searchResultsTableView.backgroundView.backgroundColor = [UIColor colorWithRed:0.13725490f green:0.12941176f blue:0.11764706f alpha:1.0f];
...
- (UISearchBar *)searchBar
{
    if (!_searchBar)
    {
        ...
        _searchBar.backgroundColor = [UIColor colorWithRed:0.13725490f green:0.12941176f blue:0.11764706f alpha:1.0f];
        _searchBar.barTintColor = [UIColor colorWithRed:0.13725490f green:0.12941176f blue:0.11764706f alpha:1.0f];
...
{
    return [UIColor colorWithRed:0.13725490f green:0.12941176f blue:0.11764706f alpha:1.0f];
}
