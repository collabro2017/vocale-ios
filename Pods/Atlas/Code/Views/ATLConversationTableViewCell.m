...
static CGFloat const ATLDateLabelRightPadding = 50.0f;
static CGFloat const ATLLastMessageLabelRightPadding = 50;
static CGFloat const ATLConversationTitleLabelRightPadding = 2.0f;
static CGFloat const ATLUnreadMessageCountLabelSize = 18.0f;
...
+ (void)initialize
{
    ...
    proxy.conversationTitleLabelColor = [UIColor lightTextColor];
    ...
    proxy.cellBackgroundColor = [UIColor clearColor];
    proxy.selectionStyle = UITableViewCellSelectionStyleGray;
}
...
- (void)lyr_commonInit
{
    ...
    _conversationImageView.layer.borderColor = [[UIColor lightGrayColor] CGColor];
    _conversationImageView.layer.borderWidth = 2.0f;
...
{
    [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:self.conversationImageView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:0 constant:60]];
...
- (void)configureUnreadMessageIndicatorLayoutConstraints
{
    ...
    [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:self.unreadMessageIndicator attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeTrailing multiplier:1.0 constant:-19]];
    [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:self.unreadMessageIndicator attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeCenterY multiplier:1.0 constant:0]];
}
