...
{
    if (avatarItem[@"UserImageMain"]) {
        PFFile *file = avatarItem[@"UserImageMain"];
        [file getDataInBackgroundWithBlock:^(NSData * _Nullable data, NSError * _Nullable error) {
            if (error != nil) {
                ...
                self.image = image;
                [[NSNotificationCenter defaultCenter] postNotificationName:@"AvatarDownloadedNotification" object:self];
            }
        }];
    } else {
