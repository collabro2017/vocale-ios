...
- (void)configureControllerForConversation
{
    ...
    self.shouldDisplayAvatarItem = (otherParticipantIDs.count > 0) ? YES : self.shouldDisplayAvatarItemForOneOtherParticipant;
...
{
    /*UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Share Current Location" message:@"Would you like to send your current location?" preferredStyle:UIAlertControllerStyleAlert];
...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations
{
    ...
    if (locations.firstObject) {
        ...
        [self sendMessageWithLocation:nil];
...
- (void)sendMessageWithLocation:(CLLocation *)location
{
    ...
    LYRMessage *message = [self messageForMessageParts:@[] MIMEType:ATLMIMETypeLocation pushText:nil];
    [self sendMessage:message];
}
